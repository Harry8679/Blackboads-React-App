...
export const socialLinks = [
    { id: 1, href: 'https://www.facebook.com/profile.php?id=100070065353546', icon: 'fab fa-facebook' },
    { id: 2, href: 'https://twitter.com/HarryMacCode', icon: 'fab fa-twitter' },
    { id: 3, href: 'https://www.youtube.com/@lahauteurdelaprofondeur1468', icon: 'fab fa-youtube' },
];
